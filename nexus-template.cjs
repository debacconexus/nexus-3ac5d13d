...
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Veterans Treatment Court";
process.env.TABLE_NAME = process.env.TABLE_NAME || "veterans_treatment_court_records";
'use strict';
